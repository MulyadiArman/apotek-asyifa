...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $image = $request->file('image')->storeAs('public/categories', Str::random(40) . '.' . $request->file('image')->extension());
    ...
    public function destroy(Category $category)
    {
        ...
        $category->delete();
        return response()->json(['success' => true, 'message' => 'Data Category Berhasil Dihapus!']);
    }
